    ...
    <div class="container-fluid  " id="divglobal">
        ...
        <div class=" col-sm-2 " id="menuderecho">
            <!---Menu lado derecho-->
                ...
                <h5 class="punto" style=" font-family: 'Lucida Sans'; font-weight: bold; font-size: 3vh; margin-top: 2vh; color: black;">
               ...
               $nombreDelUsuario = $_SESSION["nombreusuario"];
                ...
                <div class=" col-sm-12 sidenavRight listnotpoint " id="mySidenavRight">
                    ...
                    <ul id="noBorder">
                        ...
                        <li class="opcioneslogin">
                        <a href="login.html" name="cerrarsession"> Cerrar sesion</a> </li>
